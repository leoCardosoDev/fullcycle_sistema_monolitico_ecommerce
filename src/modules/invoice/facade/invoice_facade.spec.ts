...
import { InvoiceModel } from '../repository/invoice_model';
import { InvoiceFacadeFactory } from '../factory/facade_factory';
...
describe("InvoiceFacade test", () => {
  ...
  it("should generate an invoice", async () => {
    ...
    expect(invoiceOnDB.dataValues.id).toBeDefined();
  ...
  it("should find an invoice", async () => {
    ...
    expect(result.id).toEqual(invoiceCreated.dataValues.id);
    ...
    expect(result.createdAt.toString()).toEqual(
      invoiceCreated.dataValues.createdAt.toString()
    );
